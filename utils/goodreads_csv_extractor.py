...
Data Structure:
  Book
  ├── goodreads (GoodreadsData) -> Populated by this script
  ├── google (GoogleBooksData)  -> Placeholder for future API script
  └── llm (LLMData)             -> Placeholder for future AI script
